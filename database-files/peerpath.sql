...
insert into system_alert (alert_id, user_id, title, description, receivers) values (1, 8, 'performance issue', 'High error rate detected in API endpoint /auth/login', '[40 2 15 22 28]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (2, 32, 'system error', 'Unauthorized data export attempt detected on UserID 1043', '[17 31 28 6 34]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (3, 9, 'security breach', 'Memory usage on API-Gateway02 exceeded 90% threshold', '[4 18 25 33 7]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (4, 34, 'security breach', 'SSL certificate for www.example.com is set to expire in 7 days', '[16 9 7 38 1]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (5, 38, 'system error', 'Scheduled maintenance window on LoadBalancer01 begins in 30 minutes', '[22 15 8 3 18 35 6]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (6, 9, 'security breach', 'User account locked due to multiple failed password attempts', '[39 30 6 28 12 15]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (7, 22, 'performance issue', 'Disk space on Drive C: is below 10% on Server01', '[15 9 4 39 22 6]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (8, 32, 'performance issue', 'Database connection pool exhausted on DB-Cluster02', '[20 23 9 26 1 38]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (9, 6, 'security breach', 'Firewall rule conflict detected between Rule-101 and Rule-203', '[17 8 13 9 37 31]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (10, 7, 'system error', 'Application Error: Failed to load configuration file on Service-A', '[29 14 36 17 31 8]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (11, 12, 'system error', 'Application Error: Failed to load configuration file on Service-A', '[26 33 5 11 13 1 38]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (12, 32, 'system error', 'Network latency exceeded 200ms for outbound traffic to 192.168.1.1', '[13 15 6 34 27 4]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (13, 6, 'system error', 'Application Error: Failed to load configuration file on Service-A', '[17 8 13 9 37 31]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (14, 20, 'system error', 'Network latency exceeded 200ms for outbound traffic to 192.168.1.1', '[14 20 27 1 38]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (15, 6, 'system error', 'Firewall rule conflict detected between Rule-101 and Rule-203', '[13 15 6 34 27 4]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (16, 26, 'system error', 'DNS resolution failure for internal.example.local', '[16 9 7 38 1]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (17, 37, 'system error', 'DNS resolution failure for internal.example.local', '[4 18 25 33 7]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (18, 16, 'system error', 'User account locked due to multiple failed password attempts', '[14 20 27 1 38]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (19, 37, 'security breach', 'Scheduled maintenance window on LoadBalancer01 begins in 30 minutes', '[31 10 18 35 25]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (20, 33, 'performance issue', 'Data synchronization delay detected between Region1 and Region2', '[14 23 32 11 19]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (21, 3, 'security breach', 'High error rate detected in API endpoint /auth/login', '[22 6 9 33]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (22, 37, 'system error', 'Database connection pool exhausted on DB-Cluster02', '[34 13 6 39 25]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (23, 22, 'system error', 'Data synchronization delay detected between Region1 and Region2', '[6 7 16 34 3 10]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (24, 7, 'performance issue', 'Firewall rule conflict detected between Rule-101 and Rule-203', '[17 31 28 6 34]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (25, 37, 'performance issue', 'Network latency exceeded 200ms for outbound traffic to 192.168.1.1', '[40 2 15 22 28]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (26, 21, 'system error', 'Unauthorized login attempt from IP 203.45.67.89 at 14:23 UTC', '[40 5 17 14 31]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (27, 14, 'performance issue', 'User account locked due to multiple failed password attempts', '[40 2 15 22 28]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (28, 17, 'security breach', 'DNS resolution failure for internal.example.local', '[4 37 10 24 38 29 9]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (29, 7, 'system error', 'Scheduled maintenance window on LoadBalancer01 begins in 30 minutes', '[35 11 2 40 19 5]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (30, 15, 'security breach', 'Firewall rule conflict detected between Rule-101 and Rule-203', '[14 20 27 1 38]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (31, 28, 'security breach', 'Scheduled maintenance window on LoadBalancer01 begins in 30 minutes', '[4 18 25 33 7]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (32, 27, 'performance issue', 'Application Error: Failed to load configuration file on Service-A', '[15 9 4 39 22 6]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (33, 21, 'performance issue', 'Service restart required on QueueManager04 after unhandled exception', '[12 3 40 16 27 8]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (34, 7, 'system error', 'Disk space on Drive C: is below 10% on Server01', '[35 14 22 11 5 3]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (35, 30, 'security breach', 'Memory usage on API-Gateway02 exceeded 90% threshold', '[14 36 20 9 32]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (36, 2, 'performance issue', 'Backup job failed on StorageNode07 due to insufficient permissions', '[14 20 27 1 38]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (37, 40, 'system error', 'Firewall rule conflict detected between Rule-101 and Rule-203', '[34 13 6 39 25]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (38, 11, 'security breach', 'Memory usage on API-Gateway02 exceeded 90% threshold', '[14 23 32 11 19]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (39, 25, 'security breach', 'Service restart required on QueueManager04 after unhandled exception', '[30 23 12 25 18 9]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (40, 5, 'performance issue', 'Network latency exceeded 200ms for outbound traffic to 192.168.1.1', '[40 24 22 29 2 5]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (41, 31, 'security breach', 'Application Error: Failed to load configuration file on Service-A', '[35 11 2 40 19 5]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (42, 40, 'security breach', 'Memory usage on API-Gateway02 exceeded 90% threshold', '[8 12 3 30 17 29]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (43, 30, 'security breach', 'Service restart required on QueueManager04 after unhandled exception', '[31 10 18 35 25]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (44, 30, 'performance issue', 'Memory usage on API-Gateway02 exceeded 90% threshold', '[16 39 7 10 13 24 2]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (45, 35, 'security breach', 'DNS resolution failure for internal.example.local', '[6 7 16 34 3 10]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (46, 1, 'performance issue', 'Data synchronization delay detected between Region1 and Region2', '[30 23 12 25 18 9]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (47, 22, 'performance issue', 'SSL certificate for www.example.com is set to expire in 7 days', '[9 11 40 33 2 36]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (48, 24, 'performance issue', 'SSL certificate for www.example.com is set to expire in 7 days', '[3 34 15 27 18]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (49, 35, 'performance issue', 'Firewall rule conflict detected between Rule-101 and Rule-203', '[4 19 15 22 29]');
insert into system_alert (alert_id, user_id, title, description, receivers) values (50, 33, 'performance issue', 'Unauthorized login attempt from IP 203.45.67.89 at 14:23 UTC', '[40 5 17 14 31]');
...
insert into coordinator (coordinator_id, admin_id, first_name, last_name, email, content, satisfaction_score, activity_status) values (1, 21, 'Gertrude', 'Luna', 'gluna0@pbs.org', 'Oversees internship placement and development programs for students ensuring alignment with academic goals and industry needs', 2, 'online');
...
insert into user (user_id, first_name, last_name, username, email, student_type, coordinator, admin, activity_status, urgency_status, search_status, user_permissions) values (1, 'Kendal', 'Bendel', 'kbendel0', 'kbendel0@yellowbook.com', 'Graduate', 1, 8, 'offline', 'not urgent', 'job found', 'reduced');
insert into user (user_id, first_name, last_name, username, email, student_type, coordinator, admin, activity_status, urgency_status, search_status, user_permissions) values (2, 'Bonnie', 'Fried', 'bfried1', 'bfried1@wsj.com', 'Graduate', 20, 14, 'online', 'not urgent', 'future applicant', 'reduced');
...
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (1, 22, 40, 27, 'I was able to apply theoretical knowledge to practical situations which enhanced my learning');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (2, 12, 24, null, 'My advisor provided excellent mentorship and helped me set achievable career goals');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (3, 27, 6, 2, 'My advisor encouraged me to take ownership of my projects and responsibilities');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (4, 24, null, 14, 'My advisor provided excellent mentorship and helped me set achievable career goals');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (5, 6, 13, 31, 'I learned how to use version control tools like Git in a real-world project');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (6, 23, null, 11, 'I was able to work on projects that aligned with my long-term career goals');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (7, 33, 9, null, 'I was able to improve my time management skills by handling multiple tasks');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (8, 17, 13, 25, 'I was able to imThe internship provided valuable hands-on experience in a real-world setting');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (9, 28, 6, null, 'The advisor’s guidance helped me improve my communication skills in a professional setting');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (10, 22, 20, 9, 'The internship helped me refine my problem-solving and critical thinking skills');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (11, 27, 8, null, 'The internship taught me how to navigate challenges in a professional environment');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (12, 38, 40, null, 'I had the chance to participate in team meetings and contribute ideas');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (13, 18, 12, null, 'The advisor’s guidance helped me improve my communication skills in a professional setting');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (14, 30, 34, null, 'The internship helped me build a strong professional network within the industry');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (15, 12, 31, null, 'The advisor provided constructive feedback that helped me improve my performance');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (16, 8, 7, null, 'I learned how to use version control tools like Git in a real-world project');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (17, 29, 31, 29, 'My advisor encouraged me to take ownership of my projects and responsibilities');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (18, 28, 38, null, 'The advisor helped me navigate office politics and professional relationships');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (19, 31, 14, 19, 'I learned how to use version control tools like Git in a real-world project');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (20, 27, 15, null, 'The advisor was very supportive and provided useful feedback on my progress');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (21, 20, 26, 29, 'The advisor provided constructive feedback that helped me improve my performance');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (22, 26, 7, null, 'The advisor was very supportive and provided useful feedback on my progress');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (23, 3, null, 7, 'I learned the importance of documentation in software development');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (24, 23, 9, null, 'The advisor was very supportive and provided useful feedback on my progress');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (25, 11, 8, null, 'The advisor helped me stay focused and motivated through challenging tasks');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (26, 19, 18, null, 'My advisor encouraged me to take ownership of my projects and responsibilities');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (27, 26, 26, null, 'My advisor encouraged me to take ownership of my projects and responsibilities');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (28, 34, 33, null, 'I was able to apply theoretical knowledge to practical situations which enhanced my learning');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (29, 20, 7, null, 'The advisor helped me stay focused and motivated through challenging tasks');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (30, 24, 34, 27, 'I gained exposure to new technologies that I hadn''t worked with before');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (31, 21, 24, 22, 'I gained exposure to new technologies that I hadn''t worked with before');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (32, 11, 14, 39, 'The internship provided me with a clearer understanding of my career direction');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (33, 38, 2, null, 'The advisor was very supportive and provided useful feedback on my progress');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (34, 20, null, 2, 'The internship helped me refine my problem-solving and critical thinking skills');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (35, 22, 21, 39, 'I was able to improve my time management skills by handling multiple tasks');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (36, 32, null, null, 'My advisor encouraged me to take ownership of my projects and responsibilities');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (37, 30, 11, 24, 'The internship provided valuable hands-on experience in a real-world setting');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (38, 22, 11, 10, 'I learned the importance of documentation in software development');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (39, 31, null, 29, 'I learned how to use version control tools like Git in a real-world project');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (40, 7, 7, null, 'I received helpful advice on how to tailor my resume and LinkedIn profile for the industry');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (41, 17, 34, 4, 'The advisor helped me navigate office politics and professional relationships');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (42, 31, 23, 21, 'I gained exposure to new technologies that I hadn''t worked with before');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (43, 29, 27, null, 'My advisor provided excellent mentorship and helped me set achievable career goals');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (44, 21, 6, 21, 'I learned the significance of collaboration and knowledge-sharing within teams');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (45, 8, 18, null, 'I gained exposure to new technologies that I hadn''t worked with before');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (46, 27, 30, 37, 'I learned how to handle constructive criticism in a positive and professional manner');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (47, 33, 28, null, 'I gained exposure to new technologies that I hadn''t worked with before');
insert into notes (note_id, user_id, employer_id, coordinator_id, text) values (48, 1, 21, 30, 'I was able to apply theoretical knowledge to practical situations which enhanced my learning');
