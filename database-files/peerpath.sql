...
insert into answer (answer_id, question, user, answer) values (1, 12, 18, 'Employers value candidates with a willingness to learn');
insert into answer (answer_id, question, user, answer) values (2, 21, 10, 'Attend career fairs to connect with potential employers');
insert into answer (answer_id, question, user, answer) values (3, 6, 17, 'Work on building a network of mentors and peers in the industry');
insert into answer (answer_id, question, user, answer) values (4, 29, 12, 'Building a GitHub profile with meaningful contributions is beneficial');
insert into answer (answer_id, question, user, answer) values (5, 15, 23, 'Ask for feedback after interviews to improve');
insert into answer (answer_id, question, user, answer) values (6, 23, 26, 'Learning in-demand programming languages increases job opportunities');
insert into answer (answer_id, question, user, answer) values (7, 32, 24, 'Learning about the company’s culture before an interview is crucial');
insert into answer (answer_id, question, user, answer) values (8, 14, 9, 'Understand the business side of technology to stand out');
insert into answer (answer_id, question, user, answer) values (9, 17, 28, 'Developing soft skills like teamwork and adaptability is critical');
insert into answer (answer_id, question, user, answer) values (10, 30, 40, 'Always have questions ready to ask during interviews');
insert into answer (answer_id, question, user, answer) values (11, 18, 34, 'Networking is a key part of job hunting');
insert into answer (answer_id, question, user, answer) values (12, 6, 24, 'Employers value candidates with a willingness to learn');
insert into answer (answer_id, question, user, answer) values (13, 11, 33, 'Stay persistent and learn from rejections');
insert into answer (answer_id, question, user, answer) values (14, 29, 23, 'Keep track of application deadlines and follow up on your submissions');
insert into answer (answer_id, question, user, answer) values (15, 29, 30, 'Tailoring your resume to each job application increases your chances');
insert into answer (answer_id, question, user, answer) values (16, 31, 25, 'Tailoring your resume to each job application increases your chances');
insert into answer (answer_id, question, user, answer) values (17, 24, 8, 'Building a strong LinkedIn profile can significantly increase your visibility');
insert into answer (answer_id, question, user, answer) values (18, 34, 8, 'Networking is a key part of job hunting');
insert into answer (answer_id, question, user, answer) values (19, 28, 30, 'Leverage your university’s career services for guidance');
insert into answer (answer_id, question, user, answer) values (20, 16, 10, 'Practice explaining technical concepts to non-technical audiences');
insert into answer (answer_id, question, user, answer) values (21, 5, 31, 'Stay persistent and learn from rejections');
insert into answer (answer_id, question, user, answer) values (22, 39, 20, 'Build your understanding of data structures and algorithms');
insert into answer (answer_id, question, user, answer) values (23, 27, 27, 'Employers value candidates with a willingness to learn');
insert into answer (answer_id, question, user, answer) values (24, 7, 11, 'Mock interviews help in gaining confidence and improving responses');
insert into answer (answer_id, question, user, answer) values (25, 27, 6, 'Ask for feedback after interviews to improve');
insert into answer (answer_id, question, user, answer) values (26, 25, 12, 'Joining professional groups or forums helps in staying updated with industry trends');
insert into answer (answer_id, question, user, answer) values (27, 27, 22, 'Maintain a clean and professional online presence');
insert into answer (answer_id, question, user, answer) values (28, 35, 15, 'Researching a company thoroughly shows your interest and preparation');
insert into answer (answer_id, question, user, answer) values (29, 27, 35, 'Joining professional groups or forums helps in staying updated with industry trends');
insert into answer (answer_id, question, user, answer) values (30, 38, 16, 'Developing a personal brand can enhance your career prospects');
insert into answer (answer_id, question, user, answer) values (31, 39, 33, 'Learn to effectively communicate your impact in previous roles or projects');
insert into answer (answer_id, question, user, answer) values (32, 11, 21, 'Leverage your university’s career services for guidance');
insert into answer (answer_id, question, user, answer) values (33, 6, 40, 'Developing a portfolio of projects demonstrates your skills');
insert into answer (answer_id, question, user, answer) values (34, 11, 38, 'Employers value candidates with a willingness to learn');
insert into answer (answer_id, question, user, answer) values (35, 38, 29, 'Learn to effectively communicate your impact in previous roles or projects');
insert into answer (answer_id, question, user, answer) values (36, 39, 11, 'Highlighting relevant coursework can make your application stand out');
insert into answer (answer_id, question, user, answer) values (37, 39, 1, 'Networking is a key part of job hunting');
insert into answer (answer_id, question, user, answer) values (38, 14, 36, 'Building a strong LinkedIn profile can significantly increase your visibility');
insert into answer (answer_id, question, user, answer) values (39, 17, 9, 'Build your understanding of data structures and algorithms');
insert into answer (answer_id, question, user, answer) values (40, 18, 32, 'Strong communication skills are as important as technical skills');
insert into answer (answer_id, question, user, answer) values (41, 4, 1, 'Stay updated with industry news and emerging technologies');
insert into answer (answer_id, question, user, answer) values (42, 33, 5, 'Researching a company thoroughly shows your interest and preparation');
insert into answer (answer_id, question, user, answer) values (43, 13, 39, 'Attend career fairs to connect with potential employers');
insert into answer (answer_id, question, user, answer) values (44, 8, 18, 'Leverage your university’s career services for guidance');
insert into answer (answer_id, question, user, answer) values (45, 35, 33, 'Keep track of application deadlines and follow up on your submissions');
insert into answer (answer_id, question, user, answer) values (46, 11, 12, 'Personal projects can set you apart from other candidates');
insert into answer (answer_id, question, user, answer) values (47, 27, 30, 'Building a strong LinkedIn profile can significantly increase your visibility');
insert into answer (answer_id, question, user, answer) values (48, 20, 32, 'Build your understanding of data structures and algorithms');
insert into answer (answer_id, question, user, answer) values (49, 6, 7, 'Practicing coding challenges regularly helps improve problem-solving skills');
insert into answer (answer_id, question, user, answer) values (50, 10, 9, 'Ask for feedback after interviews to improve');